...
We have successfully reimplemented the Track 3 Octonionic Simulation into a real C-based ZEE200 GTZK Proof.
You can find the track3 code in `benchmarks/track3/track3.c` and its generated ZK artifacts.
