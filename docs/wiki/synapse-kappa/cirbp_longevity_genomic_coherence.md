...
### 🚨 Protocolo de Gatilhos de Alerta (MTT Alert System)
| Nível | Viabilidade (%) | Código | Ação Imediata |
|-------|----------------|--------|---------------|
| **🟢 Normal** | 85 - 100 | GREEN-001 | Continuar ensaio |
| **🟡 Atenção** | 70 - 84 | YELLOW-001 | Suspender escalonamento; repetir em duplicata |
| **🔴 Crítico** | < 70 | RED-001 | **Abortar ensaio**; ativar protocolo de resgate |
| **⚫ Tóxico** | < 50 | BLACK-001 | Descartar lote; investigar contaminação |

#### Gatilhos Estatísticos:
- **Tendência (3σ):** Alerta YELLOW se queda > 2 desvios padrão entre time-points.
- **Dose-Resposta:** Alerta YELLOW se queda > 20% na dobra de dose.

### 📡 Calibração de Campo (Bio-Link)
A precisão do campo magnético é crítica para a coerência. O protocolo de mapeamento exige desvios menores que **$\pm 2 \mu T$** na superfície de trabalho.
Detalhes em: [[tzinor-core/src/biology/cirbp/magnetic_mapping_protocol|magnetic_mapping_protocol.md]].
