...
export let state: SimulationState = {
  ...
  enterpriseSubagents: {
    governance: [
      ...
      { id: 'G3_Standby', name: 'Standby Queue', theory: 'Teoria das filas (Erlang)', function: 'Gerencia o pool de nós reserva prontos para substituição via ZK-Health', metric: 'Nós prontos: 5 (T2* > 45μs)', status: 'idle', lastAction: 'Aguardando atestação de saúde', nip: 'NIP-30' },
