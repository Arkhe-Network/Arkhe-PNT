...
export let state: SimulationState = {
  ...
  populationFeedback: [
    ...
    },
    {
      ...
      year: 2027,
      message: 'Consigo ver os jardins suspensos na Av. Rio Branco através da lente.',
      coherence: 0.9991,
      timestamp: new Date().toISOString()
    },
    {
      id: 'fb_3',
      residentName: 'Juliana Mendes',
      year: 2027,
      message: 'O canal qhttp permitiu falar com minha versão futura. Emocionante.',
      coherence: 0.9995,
      timestamp: new Date().toISOString()
    }
  ],
  ...
  latentCoherence: {
    ...
    coct: [],
    summary: {
      avg_lambda_cot: 0.4457,
      avg_lambda_coct: 0.6667,
      peak_lambda_coct: 0.8838,
      ep_reached: false
    }
  },
  layerSweep: {
    ...
    cot_sweep: [],
    coct_sweep: [],
    summary: 'Awaiting Layer-Sweep execution...'
  },
  solarEntropy: {
    timestamp: new Date().toISOString(),
    period: [1950, 2026],
  ...
  thermodynamicTraining: {
    timestamp: new Date().toISOString(),
    method: 'Onsager-Machlup Action Functional',
    parameters: {
      n_oscillators: 64,
      final_loss: 2.25
    },
